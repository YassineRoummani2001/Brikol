...
class ServiceDetailsComponenet extends Component
{
    public $service_slug;
    ...
    public function render()
    {
        ...
        return view('livewire.service-details-componenet',['service'=>$service , "r_service"=>$r_service])->layout('layouts.base');
    }
}
