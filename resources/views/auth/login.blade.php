                                ...
                                <div class="thinborder-ontop">
                                    ...
                                    <form id="userloginform" method="POST" accept="{{ route('login') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="email" type="email" class="form-control" name="email" value="" required="" autofocus="" placeholder="Enter email here">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="password"
                                            ...
                                            <div class="col-md-6">
                                                <input id="password" type="password" class="form-control" name="password" required="" placeholder="Enter pasword here">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-6">
