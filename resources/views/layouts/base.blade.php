                ...
                <div class="row" >
                    <div class="col-md-6" >
                        <ul class="visible-md visible-lg text-left" >
                            <li><a href="tel:+221656780853"><i class="fa fa-phone"></i> +221-656780853</a></li>
                            <li><a href="mailto:contact@brikol.in"><i class="fa fa-envelope"></i>
                                    contact@brikol.in</a></li>
                        </ul>
                        {{-- <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+221656780853"><i class="fa fa-phone"></i>
                                    +221-656780853</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i>Rabat, Morocco</a></li>
                        </ul> --}}
                    </div>
                    <div>
                <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> <a href="{{ route('home.contact') }}">Contact Us</a></li>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="{{ route('home.service_categories') }}">Special Services</a>
                        <ul class="drop-down one-column hover-fade">
                    ...
                    @if (Route::has('login'))
                        @auth
                            @if(Auth::user()->utype == 'ADM')
                                <li class="login-form "> <a href="#" title="Register">My Acount (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('admin.service_providers') }}">All Servise Providers</a></li>
                                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                    </ul>
                                </li>
                                @elseif(Auth::user()->utype == 'SVP')
                                    <li class="login-form"> <a href="#" title="Register">My Acount (S Provider)</a>
                                        <ul class="drop-down one-column hover-fade">
                                            <li><a href="{{ route('home') }}">Dasboard</a></li>
                                            <li><a href="{{ route('sprovider.profile') }}">Profile</a></li>
                                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                        </ul>
                                    </li>
                                    @else
                                        <li class="login-form"> <a href="#" title="Register">My Acount (Customer)</a>
                                            <ul class="drop-down one-column hover-fade">
                                                <li><a href="{{ route('home') }}">Dasboard</a></li>
                                                <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                            </ul>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            ...
                            @else
                            <li><a href="{{ route('home.change_location') }}"><i class="fa fa-map-marker"></i> Rabat,Morocco</a></li>
                            @endif
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@brikol.in">contact@brikol.in</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+221656780853">+221-656780853</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+221656780853">+221-656780853</a>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="nav-footer">
                                ...
                                <li><a href="{{ route('home.terms-of-use') }}">Terms of Use</a></li>
                                <li><a href="{{ route('home.privacy') }}">Privacy</a></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2025 brikol. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
