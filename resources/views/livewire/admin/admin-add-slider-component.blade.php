                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="addNewSlide" >
                                        @csrf
                                            <div class="form-group">
                                                <label for="title" class="control-label col-sm-3">Slider Title :</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <label for="status" class="control-label col-sm-3">Slider Statu :</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <label for="image" class="control-label col-sm-3">Slider Image :</label>
                                                <div class="col-sm-9">
