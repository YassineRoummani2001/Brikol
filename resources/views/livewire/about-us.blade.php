                ...
                <div class="paddings">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div id="single-carousel" style="border-radius: 15px">
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="img/gallery-2/1.jpg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="{{ asset('assets/img/gallery-2/1.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="img/gallery-2/2.jpg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="{{ asset('assets/img/gallery-2/2.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="img/gallery-2/3.jpg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="{{ asset('assets/img/gallery-2/3.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-12">
                                <div class="container">
                                    <div class="row">
                                        <div class="titles">
                                            <h2><span>¿</span>Why <span>Book</span> in BRIKOL<span>?</span></h2>
