...
<div class="section-title-01 honmob">
        ...
        <section class="content-central" style="border-radius: 15px">
            ...
            <div class="content_info" style="border-radius: 15px">
                <div class="paddings-mini">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 single-blog">
                                <div class="post-item" style="border-radius: 15px">
                                    <div class="row" style="border-radius: 15px">
                                        <div class="col-md-12">
                                            <div class="post-header" style="border-radius: 15px">
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover" style="border-radius: 15px">
                            ...
                            <div class="col-md-4">
                                <aside class="widget" style="margin-top: 18px; " >
                                    <div class="panel panel-default" style="border-radius: 15px;">
                                        <div class="panel-heading" style="border-top-left-radius: 15px; border-top-right-radius: 15px;">Booking Details</div>
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    <td style="border-top: none;">Price</td>
                                                    <td style="border-top: none;">{{ $service->price }} DH</td>
                                                </tr>
                                                <tr>
                                                    <td>Quntity</td>
                                                    <td>1</td>
                                ...
                                <aside>
                                    ...
                                    <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                        style="max-width: 360px ;border-radius: 15px" >
                                        <a href="{{ route('home.service_details',['service_slug'=>$r_service->slug]) }}">
                                            ...
                                            <div class="info-gallery" style="border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                                                ...
                                                <div class="content-btn"><a href="{{ route('home.service_details',['service_slug'=>$r_service->slug]) }}"
                                                        class="btn btn-warning" style="border-radius: 15px">View Details</a></div>
                                                <div class="price"><b>From</b>{{$r_service->price}} DH</div>
                                            </div>
                                        </a>
                                    </div>
                                    @endif
