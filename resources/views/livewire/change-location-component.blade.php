    ...
    <div class="content_info">
        <div class="paddings-mini">
            <div class="container">
                ...
                <div class="alert alert-success col-md-8 ml-8" role="alert">{{Session::get('message')}}</div>
                @endif
                <div class="row">
                    <form wire:submit.prevent="changeLocation">
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control" id="autocomplete" name="location"
                                placeholder="Search Location...." wire:model="city" readonly>
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=MPgB6CqPwmBB2pMs8"
                                    allowfullscreen=""
                                    loading="lazy">
                                </iframe>
                        </div>
                                ...
                                <address>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="street_number"
                                            name="streetnumber" wire:model="streetnumber" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="routes" class="col-form-label">Route:</label>
                                        <input type="text" class="form-control" id="route" name="routes" wire:model="routes" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="city" class="col-form-label">City:</label>
                                        <input type="text" class="form-control" id="locality" name="city" wire:model="city" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="state" class="col-form-label">State:</label>
                                        <input type="text" class="form-control" id="administrative_area_level_1"
                                            name="state" wire:model="state" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="country" class="col-form-label">Country:</label>
                                        <input type="text" class="form-control" id="country" name="country" wire:model="country" required>
                                    </div>
                                    <div class="form-group">
